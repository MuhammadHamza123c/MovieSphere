...
const nav = [
  ...
  { to: '/ai', label: 'AI', icon: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
]
...
export default function Sidebar() {
  ...
  return (
    <aside className="group w-14 hover:w-56 bg-[#12142a] border-r border-[#1e2040] flex flex-col flex-shrink-0 h-screen sticky top-0 transition-all duration-200 z-50">
      ...
      {user && (
        <div className="py-4 border-t border-[#1e2040]">
